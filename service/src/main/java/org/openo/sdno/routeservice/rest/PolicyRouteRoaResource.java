...
import org.openo.sdno.routeservice.util.check.CheckPolicyRoute;
...
import org.openo.sdno.routeservice.util.operation.PolicyRouteNbiToSbi;
...
/**
 * The rest interface of policy route. <br>
 * 
 * @author
 * @version SDNO 0.5 Jan 9, 2017
 */
@Service
@Path("/sdnoroute/v1/policy-routes")
public class PolicyRouteRoaResource {
    ...
    @Resource
    private PolicyRouteService policyRouteSvc;

    public PolicyRouteService getPolicyRouteSvc() {
        return policyRouteSvc;
    }

    public void setPolicyRouteSvc(PolicyRouteService policyRouteSvc) {
        this.policyRouteSvc = policyRouteSvc;
    }
     ...
     * @param uuidList Collection of policy routes UUID
     * @return Collection of NbiNePolicyRoute object
    ...
    public List<NbiNePolicyRoute> batchQuery(@Context HttpServletRequest req, @Context HttpServletResponse resp,
     ...
     * @param req HttpServletRequest Object
     * @param resp HttpServletResponse Object
     * @param routeId UUID of policy route
     * @return NbiNePolicyRoute object
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public NbiNePolicyRoute query(@Context HttpServletRequest req, @Context HttpServletResponse resp,
    ...
    /**
     * Batch create policy routes.<br/>
     * 
     * @param req HttpServletRequest Object
     * @param resp HttpServletResponse Object
     * @param nbiRoutes Collection of NbiNePolicyRoute object
     * @return Collection of NbiNePolicyRoute object
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public List<NbiNePolicyRoute> create(@Context HttpServletRequest req, @Context HttpServletResponse resp,
    ...
    /**
     * Deploy/Undeploy policy routes.<br/>
     * 
     * @param req HttpServletRequest Object
     * @param resp HttpServletResponse Object
     * @param nbiActionModel NbiActionModel Object
     * @return Collection of successful UUID
     * @throws ServiceException when deploy or undeploy policy routes failed
     * @since SDNO 0.5
     */
    @POST
    @Path("/action")
    ...
    public List<String> action(@Context HttpServletRequest req, @Context HttpServletResponse resp,
        ...
        if(!CollectionUtils.isEmpty(nbiActionModel.getDeploy())) {
            ...
            rsp = policyRouteSvc.undeploy(req, resp, nbiActionModel.getUndeploy());
        } else {
        ...
        LOGGER.info("Exit deploy/undeploy policy routes method. cost time(ms): "
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public List<NbiNePolicyRoute> update(@Context HttpServletRequest req, @Context HttpServletResponse resp,
            List<NbiNePolicyRoute> nbiRoutes) throws ServiceException {
    ...
    /**
     * Delete policy route.<br/>
     * 
     * @param req HttpServletRequest Object
     * @param resp HttpServletResponse Object
     * @param routeId UUID of policy route
     * @return UUID of policy route
