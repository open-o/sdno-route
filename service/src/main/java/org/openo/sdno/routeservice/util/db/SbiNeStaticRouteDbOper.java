...
public class SbiNeStaticRouteDbOper {
    ...
    public static void delete(String routeId) throws ServiceException {
        ...
        SbiNeStaticRoute SbiNeStaticRoute = queryDbRsp.getData().get(0);
        new InventoryDaoUtil<SbiNeStaticRoute>().getInventoryDao().delete(SbiNeStaticRoute.class,
                SbiNeStaticRoute.getUuid());
    }
    ...
    public static void updateDeploySuccess(List<SbiNeStaticRoute> sbiRoutes, List<SbiNeStaticRoute> succRoutes)
        ...
        List<SbiNeStaticRoute> updateList = new ArrayList<SbiNeStaticRoute>();
